...
import { useSendMoneyMutation, useWalletQuery } from "@/redux/features/wallets/wallet.api";
...
const SendMoney = () => {
  ...
  const { data: walletData } = useWalletQuery(walletId!, { skip: !walletId });
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-semibold text-gray-700">Receiver</FormLabel>
          ...
          <div className="mt-6 p-3 bg-orange-50 rounded-lg border border-orange-100">
            <p className="text-sm text-gray-600">
              💡 <span className="font-semibold">Note:</span> You can send money up to your available balance (৳ {balance.toLocaleString()}).
            </p>
          </div>
        </div>
      </div>
